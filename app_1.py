...
if "current_genre" not in st.session_state or st.session_state.current_genre != selected_genre:
    ...
    st.session_state.current_radius = 50 if selected_genre == "漢字" else 100
...
# 難易度設定
initial_radius = 50 if st.session_state.current_genre == "漢字" else 100
blur_step = -1 if st.session_state.current_genre == "漢字" else -5
